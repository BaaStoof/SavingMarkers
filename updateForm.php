...
<html lang="en-us">
    ...
    <body onload="initMap()">
        <nav class="navbar fixed-top navbar-dark bg-dark">
            <a class="navbar-brand" href="#"><strong>Modification les Information d'un Client</strong></a>
        </nav>
        <header>
            <div class="container-fluid">
                <div class="row">  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="text-center"><a href="allClient.php" class="btn btn-info" type="submit">Afficher en Table</a></div>
